...
matric: # Words ending with ':' are **labels**
        ...
        .word 4648  # This directive reserves enough space for a word in memory
...
prog:   # Labels in code are used for control flow: if/then/else, loops, etc.
        ...
        lw         s0, 0(a0)       # Get from the first value of a0(so the matric) into register s0. lw - load word 
